...
def parser_gen():
    ...
    parser.add_argument(
        ...
        type=int,
        default=16,
        help="Number of bits for lm_head weights. Set to 8 or 4 to quantize lm_head independently.",
    )
    parser.add_argument(
        "--lm_head_w_groupsize",
        type=int,
        default=-1,
        help="Groupsize for lm_head weight quantization. Use -1 to follow w_groupsize, 0 to disable grouping, or a positive value to set it explicitly.",
    )
    parser.add_argument(
        "--embed_w_bits",
        type=int,
        default=16,
        help="Number of bits for embedding weights. Set to 8 or 4 to quantize model.embed_tokens independently.",
    )
    parser.add_argument(
        "--embed_w_groupsize",
        type=int,
        default=-1,
        help="Groupsize for embedding weight quantization. Use -1 to follow w_groupsize, 0 to disable grouping, or a positive value to set it explicitly.",
    )
    parser.add_argument(
        "--nsamples",
        type=int,
    ...
    # SVD_LLM_ckpt
    parser.add_argument(
        "--svd_llm_ckpt", type=str, default='', help="The path of compressed SVD_LLM_ckpt"
    )
