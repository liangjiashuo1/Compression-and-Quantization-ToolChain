CUDA_VISIBLE_DEVICES=4 torchrun --master-port=29878 --nnodes=1 --nproc_per_node=1 ./vis_weight_compare.py \
...
--rmid_mode random \
--rmid_path /data1/ljs/Codex_AFM_SPINQuant/llama_rotation_split_AFM/0_20260512_214428/layerwise_rmid_final.bin